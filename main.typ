...
#block[
  #text(14pt, strong[Sample information])
]
#" "
...
#table(
  ...
  table.header(
    ...
    [*Affection status (cause of testing)*],
    [*Family ID*]
  ),
  [9-2025],
  [JD],
...
#line(length: 100%)
#block[
  #text(14pt, strong[Target information])
]
#" "
...
#table(
  ...
  [#table(
    ...
    [*Disease abbreviation*], [DM1],
    [*OMIM ID*], [#160900],
    [*Motif complexity*], [Simple (interruptions may occur)],
    [*Clinically relevant unit (HGVS)*], [GCA],
    [*Clinically relevant unit (historical)*], [CTG],
    [*Whole motif (HGVS)*], [GCA],
    [*Whole motif (historical)*], [CTG],
    [*HGVS nomenclature (GRCh38)*], [NC_000019.10:g.45770207_45770266GCA[20]],
    [*Molecular mechanism*], [Complex; Spliceopathy; ...],
    [*Motif - Notes*], [Nothing to note],
    [*Citation (references)*], [Abrakadabra et al. 2002],
  )], [#table(
        align: left,
        columns: 2,
        stroke: none,
        [*Gene*], [Dystrophia myotonica protein kinase],
        [*Gene abbreviation*], [DMPK],
        [*Inheritance*], [AD (anticipation)],
        [*Physiological range*], [5-35], 
        [*Premutation range*], [35-50],
        [*Pathogenic range*], [50+],
        [*Grey-zone range*], [-],
      )], [#table(
            align: left,
...
#block[
  #text(10pt, [GRCh38 reference allele- Visualisation])
]
...
#line(length: 100%)
#block[
  #text(14pt, strong[Results of analysis])
]
#" "
...
#table(
  ...
  [9-2025], [JD], [Allele 1], [5], [chr19:g.45770207_45770266GCA[5]], [Benign], [100.00%],
  [], [], [Allele 2], [12], [chr19:g.45770207_45770266GCA[12]], [Benign], [100.00%],
)
...
#line(length: 100%)
#block[
  #text(14pt, strong[Details of results])
]
#" "
